<div class="row">
    <div class="col-sm-3 searchbar">
      <form action="/projectEG-php/widget/search-page/searchpage.php" method="post" class="searchbox">
      ...
      <a href="/projectEG-php/index.php" class="searchbar-link">
        Discover
      </a>
      <a href="/projectEG-php/widget/search-page/searchpage.php" class="searchbar-link">
        Browse
      </a>
      <a href="" class="searchbar-link">
        News
      </a>
      <a href="/projectEG-php/widget/cart.php" class="cart-link searchbar-link">Cart</a>
    </div>
</div>
