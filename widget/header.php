<header id="header">
    <ul class="nav-list">
        ...
        <li class="nav-item">
            <a href="/projectEG-php/index.php" class="nav-link">STORE</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a href="" class="nav-link">UNREAL ENGINE</a>
        </li>
    </ul>
    <ul class="nav-list">
        <li class="nav-item nav-item--no-animation">
        ...
        <?php
            ...
            if((isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true)) {
                        ...
                        <a href="#" class="btn nav-link">
                            ...
                            <div class="user-menu">
                                <ul class="user-menu__list">
                                    ...
                                    <li class="user-menu__item">
                                        <a href="/projectEG-php/assets/php/logout.php" class="user-menu__link">SIGN OUT</a>
                                    </li>
                                </ul>
                            </div>
                        </a>
                ...
                echo '
                    <li class="nav-item nav-item--no-animation">
                        <a href="/projectEG-php/widget/login.php" class="btn nav-link">
                            <i class="nav-icon fa-solid fa-user"></i>
                            SIGN IN
                        </a>
                    </li>
