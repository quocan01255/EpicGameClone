                        ...
                        <?php
                            if (isset($_SESSION['email'])) {
                                ...
                                if ($row = mysqli_fetch_array($checkCart)) {
                                    do {
                                        $gameid = $row['gameid'];
                                        $gameDetail = mysqli_query($conn, "SELECT * FROM listgame WHERE gameid = '$gameid'") or die(mysqli_error($conn));
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-10 cart-card__detail">
                                                            <div class="card-body">
                                                                ...
                                                                <a href="/projectEG-php/widget/detail.php?id='.$gameid.'" class="card-text cart-card__name">'.$name.'</a>
                                                                <a href="/projectEG-php/assets/php/removeGame.php?id='.$gameid.'" class="card-text cart-card__remove">Remove</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                echo '<script>window.location = "/projectEG-php/widget/login.php"</script>';
                            }
                        ?>
                    </div>
                    <div class="col-4">
